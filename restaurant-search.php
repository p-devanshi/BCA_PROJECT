...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>Restaurant on Your Search <a href="#" class="text-white">"<?php echo $search; ?>"</a></h2>
...
<section class="categories">
        ...
        <?php 
            ...
            $sql = "SELECT * FROM tbl_restaurant WHERE title LIKE '%$search%'";
...
<a href="<?php echo SITEURL; ?>restaurant-foods.php?category_id=<?php echo $id; ?>">
